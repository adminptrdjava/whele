...
<body>
    <form id="slick-login" action="LoginPerform" method="POST">
<label for="username">username</label><input type="text" name="uid" class="placeholder" placeholder="me@tutsplus.com">
